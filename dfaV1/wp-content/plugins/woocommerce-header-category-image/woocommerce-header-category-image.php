 ...
 * Plugin URI: http://www.themes4.net
 * Description: Add a Header Image to WooCommerce Product Category.
 * Version: 1.0.0
 * Author: Dzung Nova
 * Author URI: http://www.themes4.net
 */
...
function woocommerce_add_category_header_img() {
	...
	<div class="form-field">
		<label><?php _e( 'Header', 'themes4' ); ?></label>
		...
		<div style="line-height:60px;">
			...
			<button type="submit" class="upload_header_button button"><?php _e( 'Upload/Add image', 'themes4' ); ?></button>
			<button type="submit" class="remove_header_image_button button"><?php _e( 'Remove image', 'themes4' ); ?></button>
		</div>
		...
		<script type="text/javascript">
			...
			jQuery(document).on( 'click', '.upload_header_button', function( event ){
				...
				header_file_frame = wp.media.frames.downloadable_file = wp.media({
					title: '<?php _e( 'Choose an image', 'themes4' ); ?>',
					button: {
						text: '<?php _e( 'Use image', 'themes4' ); ?>',
					},
					multiple: false
				});
...
function woocommerce_edit_category_header_img( $term, $taxonomy ) {
	...
	<tr class="form-field">
		<th scope="row" valign="top"><label><?php _e( 'Header', 'themes4' ); ?></label></th>
		<td>
