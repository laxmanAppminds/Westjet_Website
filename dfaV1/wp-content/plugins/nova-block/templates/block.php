...
if ($id || $name) {
    $el_class = bazien_shortcode_extract_class( $el_class );
    ...
    if ($posts->have_posts()) {
        ...
        if (class_exists('Ultimate_VC_Addons')) {
            ...
            // register js
            wp_register_script('ultimate-script', $bazien_ult_assets . 'min-js/ultimate.min.js', array('jquery'), ULTIMATE_VERSION, false);
            wp_register_script('ultimate-appear', $bazien_ult_assets . 'min-js/jquery.appear.min.js', array('jquery'), ULTIMATE_VERSION);
            wp_register_script('ultimate-custom', $bazien_ult_assets . 'min-js/custom.min.js', array('jquery'), ULTIMATE_VERSION);
            wp_register_script('ultimate-vc-params', $bazien_ult_assets . 'min-js/ultimate-params.min.js', array('jquery'), ULTIMATE_VERSION);

            // register css
            wp_register_style('ultimate-animate', $bazien_ult_assets . 'min-css/animate.min.css', array(), ULTIMATE_VERSION);
            wp_register_style('ultimate-style', $bazien_ult_assets . 'min-css/style.min.css', array(), ULTIMATE_VERSION);
            wp_register_style('ultimate-style-min', $bazien_ult_assets . 'min-css/ultimate.min.css', array(), ULTIMATE_VERSION);
            ...
            if($ultimate_css == "enable"){
                ...
                //if( stripos( $post_content, '[ultimate_carousel') ) {
                //	wp_enqueue_style("ult-slick", $bazien_ult_assets . 'slick/slick.css');
                //	wp_enqueue_style("ult-icons", $bazien_ult_assets . 'slick/icons.css');
                //}
            } else {
                ...
                if( stripos( $post_content, '[icon_counter') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('ultimate-style');
                    wp_enqueue_style('aio-flip-style', $bazien_ult_assets . 'min-css/flip-box.min.css');
                }
                if( stripos( $post_content, '[ult_countdown') ) {
                    wp_enqueue_style('countdown_shortcode', $bazien_ult_assets . 'min-css/countdown.min.css');
                }
                if( stripos( $post_content, '[ultimate_icon_list') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('aio-tooltip', $bazien_ult_assets . 'min-css/tooltip.min.css');
                }
                if( stripos( $post_content, '[ultimate_carousel') ) {
                    wp_enqueue_style("ult-slick", $bazien_ult_assets . 'slick/slick.css');
                    wp_enqueue_style("ult-icons", $bazien_ult_assets . 'slick/icons.css');
                    wp_enqueue_style("ult-slick-animate", $bazien_ult_assets . 'slick/animate.min.css');
                ...
                if( stripos( $post_content, '[ult_buttons') ) {
                    wp_enqueue_style( 'ult-btn', $bazien_ult_assets . 'min-css/btn-min.css' );
                }
                if( stripos( $post_content, '[ultimate_heading') ) {
                ...
                if( stripos( $post_content, '[bsf-info-box') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('info-box-style', $bazien_ult_assets . 'min-css/info-box.min.css');
                }
                if( stripos( $post_content, '[info_circle') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('info-circle', $bazien_ult_assets . 'min-css/info-circle.min.css');
                }
                if( stripos( $post_content, '[ultimate_info_banner') ) {
                ...
                if( stripos( $post_content, '[icon_timeline') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('aio-timeline', $bazien_ult_assets . 'min-css/timeline.min.css');
                }
                ...
                if( stripos( $post_content, '[interactive_banner_2') ) {
                    wp_enqueue_style('utl-ib2-style', $bazien_ult_assets . 'min-css/ib2-style.min.css');
                }
                if( stripos( $post_content, '[interactive_banner') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('aio-interactive-styles', $bazien_ult_assets . 'min-css/interactive-styles.min.css');
                }
                ...
                if( stripos( $post_content, '[ultimate_modal') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('ultimate-modal', $bazien_ult_assets . 'min-css/modal.min.css');
                }
                if( stripos( $post_content, '[ultimate_info_table') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style("ultimate-pricing", $bazien_ult_assets . 'min-css/pricing.min.css');
                }
                ...
                if( stripos( $post_content, '[swatch_container') ) {
                    wp_enqueue_style('swatchbook-css', $bazien_ult_assets . 'min-css/swatchbook.min.css');
                }
                if( stripos( $post_content, '[stat_counter') ) {
                    wp_enqueue_style('ultimate-animate');
                    wp_enqueue_style('stats-counter-style', $bazien_ult_assets . 'min-css/stats-counter.min.css');
                }
                if( stripos( $post_content, '[ultimate_video_banner') ) {
            ...
            wp_register_script('ultimate-appear', $bazien_ult_assets . 'min-js/jquery.appear.min.js', array('jquery'), ULTIMATE_VERSION, true);
            wp_register_script('ultimate-custom', $bazien_ult_assets . 'min-js/custom.min.js', $dependancy, ULTIMATE_VERSION, true);
            wp_register_script('ultimate-smooth-scroll', $bazien_ult_assets . 'js/SmoothScroll.js', array('jquery'), ULTIMATE_VERSION, true);
            ...
            if(function_exists('vc_is_editor')){
                if(vc_is_editor()){
                    wp_enqueue_style('vc-fronteditor', $bazien_ult_assets . 'min-css/vc-fronteditor.min.css');
                }
            }
            ...
            if( stripos( $post_content, '[ultimate_google_map') ) {
                if (!wp_script_is('googleapis', 'done')) {
                    echo "<script type='text/javascript' src='https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&ver=".bazien_version."'></script>";
        ...
        $output .= '<div class="bazien-block '. $el_class . '"';
        if ($animation_type)
        ...
        if (get_post_meta( get_the_ID(), 'container', true ) == 'yes')
            $output .= '</div>';
        $output .= '</div>' . bazien_shortcode_end_block_comment( 'bazien_block' ) . "\n";
