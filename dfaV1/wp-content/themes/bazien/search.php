		...
		<div class="row">
			<div class="large-9 large-centered columns">
				...
				<header class="page-header">
					<h1 class="page-title search-results-title"><span class="top-page-excerpt"><?php printf( __( 'Search Results for %s', 'bazien' ), '<span class="page-title">' . get_search_query() . '</span>' ); ?></span></h1>
				</header><!-- .page-header -->
									...
									<?php
										...
										<div class="search_result_item">
											...
											<h1 class="entry-title-archive">
												<a href="<?php echo has_post_format('link') ? esc_url( bazien_get_link_url() ) : the_permalink() ; ?>" class="thumbnail_archive">
