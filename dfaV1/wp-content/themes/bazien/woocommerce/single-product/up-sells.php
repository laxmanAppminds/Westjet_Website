...
if ( $products->have_posts() ) : ?>
    ...
    <div id="upsells-products-carousel" class="owl-carousel upsells products slider-items-products hidden-buttons">
    ...
    <div class="<?php echo $upsells_products_centered_column; ?> large-centered medium-centered small-centered columns">
        <div class="row">
            ...
            <?php while ( $products->have_posts() ) : $products->the_post(); ?>
                ...
                <div class="slider-items <?php echo $upsells_products_item_column; ?> columns">
                    <ul>
