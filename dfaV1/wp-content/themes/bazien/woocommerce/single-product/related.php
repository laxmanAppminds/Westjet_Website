<?php global $bazien_theme_options; ?>

<?php if ( (isset($bazien_theme_options['related_products'])) && ($bazien_theme_options['related_products'] == "1" ) ) : ?>
    ...
    <div class="<?php echo $related_products_centered_column; ?> large-centered medium-centered small-centered columns">
        <div class="row">
            ...
            <?php while ( $products->have_posts() ) : $products->the_post(); ?>
                ...
                <div class="slider-items <?php echo $related_products_item_column; ?> columns">
                    <ul>
