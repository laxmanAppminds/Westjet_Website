...
global $woocommerce_loop, $bazien_theme_options;
?>
...
if ( ( isset($woocommerce_loop['columns']) && $woocommerce_loop['columns'] != "" ) ) {
    ...
    if ( ( !isset($bazien_theme_options['products_per_column']) ) ) {
        $products_per_column = 4;
    } else {
        $products_per_column = $bazien_theme_options['products_per_column'];
...
<div class="row">
    <div class="large-12 columns">
        <ul id="products-grid" class="products product products-grid small-block-grid-2 medium-block-grid-<?php echo $products_per_column_medium; ?> large-block-grid-<?php echo $products_per_column_large; ?> xlarge-block-grid-<?php echo $products_per_column_xlarge; ?> xxlarge-block-grid-<?php echo $products_per_column; ?>">