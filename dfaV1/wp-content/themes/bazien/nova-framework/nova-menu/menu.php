...
add_filter( 'wp_setup_nav_menu_item', 'bazien_add_custom_nav_fields' );

function bazien_add_custom_nav_fields( $menu_item ) {
...
add_action( 'wp_update_nav_menu_item', 'bazien_update_custom_nav_fields', 10, 3 );

function bazien_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
...
// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'bazien_edit_walker', 10, 2 );

function bazien_edit_walker($walker,$menu_id) {
...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-icon-<?php echo $item_id; ?>">
            ...
            <span><?php echo __('Input font awesome icon or icon class. You can see <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">Font Awesome Icons in here</a>.', 'bazien') ?></span>
        </label>
    </p>
    <p class="description">
...
/* Top Navigation Menu */
if (!class_exists('bazien_top_navwalker')) {
    class bazien_top_navwalker extends Walker_Nav_Menu {
        ...
        function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ($item->block)
                $item_output .= '<div class="menu-block menu-block-after">'.do_shortcode('[bazien_block name="'.$item->block.'"]').'</div>';
...
/* Sidebar Menu */
if (!class_exists('bazien_sidebar_navwalker')) {
    class bazien_sidebar_navwalker extends Walker_Nav_Menu {
...
/* Accordion Menu */
if (!class_exists('bazien_accordion_navwalker')) {
    class bazien_accordion_navwalker extends Walker_Nav_Menu {
