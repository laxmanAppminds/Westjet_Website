...
function page_options_meta_box_content()
{
    ...
    <p>
        <select name="page_header_transparency" id="page_header_transparency" style="width:100%">
            ...
            <option value="header_transparent_light_present" <?php selected( $selected, 'header_transparent_light_present' ); ?>>Light</option>
            <option value="header_transparent_dark_present" <?php selected( $selected, 'header_transparent_dark_present' ); ?>>Dark</option>
