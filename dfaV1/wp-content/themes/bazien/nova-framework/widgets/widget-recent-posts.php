<?php
add_action( 'widgets_init', 'register_nova_recent_posts_widget' );

function register_nova_recent_posts_widget() {
    register_widget( 'Nova_Recent_Posts_Widget' );
}
if( ! function_exists( 'nova_get_categories' ) )
{
    function nova_get_categories( $category ) {
        $categories = get_categories( array( 'taxonomy' => $category ));

        $array = array( '' => __( 'All', 'bazien' ) );
...
class Nova_Recent_Posts_Widget extends WP_Widget {

	
	/* ---------------------------------------------------------------------------
	 * Constructor
	 * --------------------------------------------------------------------------- */
	function Nova_Recent_Posts_Widget() {
		$widget_ops = array( 'classname' => 'widget_nova_recent_posts', 'description' => __( 'The most recent posts on your site.', 'bazien' ) );
		$this->WP_Widget( 'widget_nova_recent_posts', __( 'Nova Recent Posts', 'bazien' ), $widget_ops );
		$this->alt_option_name = 'widget_nova_recent_posts';
	}
	...
	function form( $instance ) {
		...
		?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'bazien' ); ?></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
			</p>
			
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php _e( 'Category:', 'bazien' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" >
					<?php 
						$categories = nova_get_categories( 'category' );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php _e( 'Number of posts:', 'bazien' ); ?></label>
