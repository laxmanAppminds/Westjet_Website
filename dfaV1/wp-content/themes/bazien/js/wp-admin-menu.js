...
jQuery(function($) {
    ...
    function update_bazien_menu_options(elem, shift) {
        ...
        if ( e.target && e.target.className ) {
            if ( -1 != e.target.className.indexOf('item-delete') ) {
                ...
                children.each(function() {
                    update_bazien_menu_options($(this), -1);
                });
            }
        }
    });
    ...
    $( "#menu-to-edit" ).on( "sortstop", function( event, ui ) {
        ...
        setTimeout(function() {
            update_bazien_menu_options(menu_item, 0);
            var children = menu_item.childMenuItems();
            children.each(function() {
                update_bazien_menu_options($(this), 0);
            })
        }, 200);
    } );
});
